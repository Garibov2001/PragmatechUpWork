...
namespace pragmatechUpWork_CoreMVC.UI.Controllers
{
    public class AccountController : Controller
    {
        ...
        public AccountController(UserManager<ApplicationUser> _userManager, RoleManager<ApplicationRole> _roleManager,SignInManager<ApplicationUser> _signInManager)
        {
        ...
        public async Task<IActionResult> Register(RegisterViewModel register)
        {
            if (ModelState.IsValid)
            {
                ...
                var userApi= GetApiData(register.Email, register.Surname, register.CRMPassword);
        ...
        public ApplicationUser GetApiData(string apiUrl,string surname,string password)
        {
            //Connect API
